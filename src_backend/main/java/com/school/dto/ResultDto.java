...
public record ResultDto(Long id, Double score, String kind, Long studentId, Long examId) {
    public static ResultDto from(Result result) {
        ...
        return new ResultDto(result.getId(), result.getScore(), result.getKind(), sid, eid);
    }
}
